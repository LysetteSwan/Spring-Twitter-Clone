...
public class Seeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        TwitterUser user3 = new TwitterUser();
        ...
        TwitterUser user4 = new TwitterUser();
        ...
        TwitterUser user5 = new TwitterUser();
        ...
        TwitterUser deletedUser = new TwitterUser();
...
//	    // ----- TWEETS -----
        ...
        user1.setUserLiked(user3Tweets);
        userRepository.saveAndFlush(user1);

        user2.setUserLiked(user1Tweets);
        user2.setUserLiked(user2Tweets);
        userRepository.saveAndFlush(user2);

        user3.setUserLiked(user2Tweets);
        userRepository.saveAndFlush(user3);

        deletedUser.setUserLiked(user2Tweets);
        userRepository.saveAndFlush(deletedUser);

        // ----- List of Following -----
        List<TwitterUser> followingList = List.of(user2, user3, user4);
        user1.setFollowing(followingList);
        userRepository.saveAndFlush(user1);
        // ----- List of Followers -----
        List<TwitterUser> followersList = List.of(user3, user5);
        ...
        // Following
        List<TwitterUser> following_1 = List.of(user2, user3, user4, deletedUser);
        user1.setFollowing(following_1);

        List<TwitterUser> followers_1 = List.of(user5, deletedUser);
